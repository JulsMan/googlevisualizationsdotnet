...
namespace GoogleChartsNGraphsControls
{
    ...
    public class GVScatterChart : BaseWebControl
    {
        ...
        [DefaultValue("none")]
        public string GviCurveType
        {
            get
            {
                string s = (string)ViewState["GviCurveType"];
                return s;
            }
        ...
        [Bindable(true)]
        [Category("GoogleOptions")]
        [Description(@"Line width in pixels. Use zero to hide all lines and show only the points.")]
        [DefaultValue(0)]
        ...
        [Bindable(true)]
        [Category("GoogleOptions")]
        [Description(@"Diameter of displayed points in pixels. Use zero to hide all points.")]
        [DefaultValue(7)]
        ...
        [Bindable(true)]
        [Category("GoogleOptions")]
        [Description(@"vAxis property that specifies the highest vertical axis grid line. The actual grid line will be the greater of two values: the maxValue option value, or the highest data value, rounded up to the next higher grid mark.")]
        [DefaultValue(0)]
        public int? GviVAxis_maxValue
        {
            get
            {
                int? s = (int?)ViewState["GviVAxis_maxValue"];
                return s;
            }

            set
            {
                ViewState["GviVAxis_maxValue"] = value;
            }
        }
        ...
        [Bindable(true)]
        [Category("GoogleOptions")]
        [Description(@"vAxis property that specifies the lowest vertical axis grid line. The actual grid line will be the lower of two values: the minValue option value, or the lowest data value, rounded down to the next lower grid mark.")]
        [DefaultValue(0)]
        public int? GviVAxis_minValue
        {
            get
            {
                int? s = (int?)ViewState["GviVAxis_minValue"];
                return s;
            }

            set
            {
                ViewState["GviVAxis_minValue"] = value;
            }
        }
        ...
        protected override void RenderContents(HtmlTextWriter output)
        {
            ...
            this.gvi.RegisterGVIScriptsEx(this, this.dt, BaseGVI.GOOGLECHART.SCATTERCHART);
            output.Write(Text);
        }
    }
}
